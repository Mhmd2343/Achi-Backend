    ...
    return (
        ...
        <div className="grid grid-cols-1 gap-[14px]">
            ...
            <input
                ...
                onChange={onChange("seoCanonical")}
            ...
            <input
                value={form.heroWhatsapp}
                onChange={onChange("heroWhatsapp")}
                className="border p-[10px] rounded-[10px]"
            />
            </label>
            ...
            <input
                ...
                onChange={onChange("whatsappHref")}
                className="border p-[10px] rounded-[10px]"
            />
            </label>
            ...
            <button
                onClick={onSave}
                className="bg-[#28509E] text-white px-[16px] py-[12px] rounded-[12px] font-[700] w-fit"
            >
                Save
            </button>
        ...
        <section id="nav-editor" className="mt-[40px] border-t pt-[26px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[12px]">
                ...
                <select
                    value={newItem.kind}
                    onChange={(e) => setNewItem((p) => ({ ...p, kind: e.target.value }))}
                    className="border p-[10px] rounded-[10px]"
                >
                ...
                <input
                    value={newItem.order}
                    onChange={(e) => setNewItem((p) => ({ ...p, order: e.target.value }))}
                    className="border p-[10px] rounded-[10px]"
                    type="number"
                />
                </label>
                ...
                <label className="flex flex-col gap-[6px]">
                    ...
                    onChange={(e) => setNewItem((p) => ({ ...p, targetId: e.target.value }))}
                    className="border p-[10px] rounded-[10px]"
                    placeholder="clients"
                    />
                </label>
                ...
                <input
                    value={newItem.labelFr}
                    onChange={(e) => setNewItem((p) => ({ ...p, labelFr: e.target.value }))}
                    className="border p-[10px] rounded-[10px]"
                />
                </label>
                ...
                <input
                    ...
                    onChange={(e) => setNewItem((p) => ({ ...p, labelAr: e.target.value }))}
                    className="border p-[10px] rounded-[10px]"
                />
                </label>
            </div>
            ...
            <div className="mt-[12px] flex gap-[10px] flex-wrap">
                <button onClick={addNewItem} className="bg-[#28509E] text-white px-[16px] py-[12px] rounded-[12px] font-[900] w-fit text-[20px] leading-none">
    +
    </button>
            ...
            {navItemsSorted.map((it) => (
                ...
                <div className="flex flex-wrap items-center justify-between gap-[10px] mb-[10px]">
                    ...
                    {it.labelKey ? (
                        <span className="text-[13px] bg-gray-100 px-[10px] py-[6px] rounded-[999px] font-[800]">{it.labelKey}</span>
                    ) : null}
                    </div>

                    <div className="flex flex-wrap gap-[8px]">
                    <button onClick={() => moveItem(it.id, "up")} className="bg-gray-200 px-[12px] py-[8px] rounded-[10px] font-[800]">Up</button>
                    <button onClick={() => moveItem(it.id, "down")} className="bg-gray-200 px-[12px] py-[8px] rounded-[10px] font-[800]">Down</button>
                    <button onClick={() => removeItem(it.id)} className="bg-red-600 text-white px-[12px] py-[8px] rounded-[10px] font-[800]">Delete</button>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-[12px]">
                    ...
                    <input
                        ...
                        onChange={(e) => setItemField(it.id, "enabled", e.target.checked)}
                    />
                    ...
                    <input
                        type="number"
                        value={it.order ?? 0}
                        onChange={(e) => setItemField(it.id, "order", Number(e.target.value))}
                        className="border p-[10px] rounded-[10px]"
                    />
                    </label>
                    ...
                    <label className="flex flex-col gap-[6px]">
                        ...
                        <input
                        value={it.path || ""}
                        onChange={(e) => setItemField(it.id, "path", e.target.value)}
                        className="border p-[10px] rounded-[10px]"
                        disabled={!!it.labelKey && it.id === "home"}
                        />
                    </label>
                    ) : (
                    <label className="flex flex-col gap-[6px]">
                        ...
                        <input
                        value={it.targetId || ""}
                        onChange={(e) => setItemField(it.id, "targetId", e.target.value)}
                        className="border p-[10px] rounded-[10px]"
                        />
                    </label>
                    )}
                    ...
                    <input
                        value={(it.label && it.label.en) || ""}
                        onChange={(e) => setItemLabelField(it.id, "en", e.target.value)}
                        className="border p-[10px] rounded-[10px]"
                        disabled={!!it.labelKey}
                    />
                    </label>
                    ...
                    <input
                        value={(it.label && it.label.fr) || ""}
                        onChange={(e) => setItemLabelField(it.id, "fr", e.target.value)}
                        className="border p-[10px] rounded-[10px]"
                        disabled={!!it.labelKey}
                    />
                    </label>
                    ...
                    <input
                        value={(it.label && it.label.ar) || ""}
                        onChange={(e) => setItemLabelField(it.id, "ar", e.target.value)}
                        className="border p-[10px] rounded-[10px]"
                        disabled={!!it.labelKey}
                    />
                    </label>
            ...
            <button
                onClick={saveNav}
                className="bg-[#28509E] text-white px-[16px] py-[12px] rounded-[12px] font-[900] w-fit"
            >
                Save Menu
            </button>
